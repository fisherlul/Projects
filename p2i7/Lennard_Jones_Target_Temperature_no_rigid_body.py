# -*- coding: utf-8 -*-
"""
Created on Tue Apr 15 10:15:17 2025
...
# ----- Suppression du mouvement du centre de masse -----
# Calcul de la vitesse du centre de masse initiale
vitesse_cm_initial = np.sum(velocities[0], axis=0) / npart

# Soustraction de la vitesse du centre de masse de toutes les vitesses initiales
velocities[0] -= vitesse_cm_initial
...
def forces_LJ(pos, box_size, rayon_coupure, epsilon, sigma):
    ...
    for i in range(npart_local):
        for j in range(i + 1, npart_local):
